...
export default function index() {
  return (
    <div className="mx-auto ">
      <Navbar />
      <section className="mb-32 px-6 text-gray-800">
        <div
        ...
        ></div>
        <div className="container mx-auto px-4 text-gray-800 md:px-12">
          <div
            className="block rounded-lg px-2 py-10 shadow-lg md:px-6 md:py-12"
            style={{
              marginTop: "-100px",
            ...
            <div className="flex flex-wrap">
              ...
              "
                  ...
                  <div className="form-group form-check mb-6 text-center">
                    <input
                      type="checkbox"
                      className="form-check-input mr-2 mt-1 h-4 w-4 cursor-pointer appearance-none rounded-sm border border-gray-300 bg-white bg-contain bg-center bg-no-repeat align-top transition duration-200 checked:border-blue-600 checked:bg-blue-600 focus:outline-none"
                      id="exampleCheck87"
                      checked
                    />
                    <label
              ...
              <div className="w-full shrink-0 grow-0 basis-auto xl:w-7/12">
                <div className="flex flex-wrap">
                  ...
                  <div className="w-full shrink-0 grow-0 basis-auto px-3 md:w-6/12 lg:px-6">
                    <div className="align-start flex">
                      <div className="shrink-0">
                        <div className="flex h-14 w-14 items-center justify-center rounded-md bg-blue-600 p-4 shadow-md">
                          <svg
